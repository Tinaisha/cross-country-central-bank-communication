...
-Converts data to monthly frequency and merges macroeconomic variables
Produces: CBQuarterly.csv (quarterly version) and CBMonthly.csv (monthly version)
...
-Includes exploratory work on document‑distance measures
(not included in the research report due to methodological limitations)
